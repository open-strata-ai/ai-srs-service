...
import com.openstrata.srs.domain.port.CachePort;
import com.openstrata.srs.domain.service.SkillVersionService;
import com.openstrata.srs.infrastructure.persistence.RuleEntity;
import com.openstrata.srs.infrastructure.persistence.RuleRepository;
...
public class SrsQueryService {
    ...
    private String resolveSkill(String tenant, String name, String version) {
        ...
        Skill active = versionService.activeVersion(versions.stream().map(e ->
            new Skill(e.getSkillId(), new com.openstrata.srs.domain.TenantId(e.getTenantId()),
                e.getName(), com.openstrata.srs.domain.SemVer.parse(e.getVersion()),
                com.openstrata.srs.domain.SkillType.valueOf(e.getType()), e.getSchemaJson(),
